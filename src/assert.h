...
#	define HASSERT(condition) \
		((condition) || (Habanero::assert_func(#condition, __FILE__, __LINE__, __FUNCTION__, __TIME__), true))
#else
...
namespace Habanero
{
	void assert_func(const char *cond, const char *file, unsigned int line, const char *func, const char *timestamp);
};
