...
/*
#define QUOTE_(s) #s
// To trzeba edytowac kiedy zmienimy katalog z implementacja zalezna od systemu
#define PDEP(hdr) QUOTE_(win_ ## hdr)

// Generowanie ostrzezen
#define QUOTE_EVAL_(s) QUOTE_(s)
#define WARNING_PREFIX __FILE__ ## "(" ## QUOTE_EVAL_(__LINE__) ## "): warning user: "
#define WARNING(msg) __pragma(message(WARNING_PREFIX ## msg))
