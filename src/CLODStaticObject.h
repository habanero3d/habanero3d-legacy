...
namespace Habanero
{
	class CLODStaticObject : public Spatial
	{
	private:
		Specific_ptr<CLODStaticMesh> mesh;

		uint computeLODLevel(const Frustum<float>&) const;
	...
	public:
		CLODStaticObject(Specific_ptr<CLODStaticMesh>);
