...
namespace Habanero
{
	...
	Window::Window(Window::Handle handle) : mouse(this)
	{
	...
	//#pragma warning(suppress:4355)
	Window::Window(const char *name, uint width, uint height, bool fullscreen) : mouse(this)
	{
	...
	//#pragma warning(suppress:4355)
	Window::Window(const std::string &name, uint width, uint height, bool fullscreen) : mouse(this)
	{
		sfmlWindow = new sf::Window();
		sfmlClock = new sf::Clock();
